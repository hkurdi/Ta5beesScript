import { addGoolMethod, addArrayMethods, addOtherArrayMethods, addStringMethods, addMathMethods, addTypeMethods, addFetchMethod, addDocumentMethods } from "./stdlib/libraries.js";
import {
  MK_BOOL,
  MK_NATIVE_FN,
  MK_NULL,
